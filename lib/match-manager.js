...
module.exports = class MatchManager {
  ...
  updateConfig() {
    ...
    this.processAutoPairs(
      this.getScopedSetting("bracket-matcher-plus.autocompleteCharacters"),
      this.pairedCharacters,
      (x) => [x[0], x[1]],
    );
    this.processAutoPairs(
    ...
    this.processAutoPairs(
      this.getScopedSetting("bracket-matcher-plus.pairsWithExtraNewline"),
      this.pairsWithExtraNewline,
      (x) => [x[0], x[1]],
    );
  ...
  constructor(editor, editorElement) {
    ...
    this.subscriptions.add(
      atom.config.observe("bracket-matcher-plus.autocompleteCharacters", { scope }, () =>
        this.updateConfig(),
      ),
      atom.config.observe("bracket-matcher-plus.pairsWithExtraNewline", { scope }, () =>
        this.updateConfig(),
      ),
