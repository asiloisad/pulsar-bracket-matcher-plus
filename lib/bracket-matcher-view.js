...
module.exports = class BracketMatcherView {
  constructor(editor, editorElement, matchManager) {
    ...
    this.subscriptions.add(
      ...
      atom.commands.add(editorElement, "bracket-matcher-plus:go-to-matching-bracket", () =>
        this.goToMatchingBracket(),
      ),

      atom.commands.add(editorElement, "bracket-matcher-plus:go-to-enclosing-bracket", () =>
        this.gotoPrecedingStartBracket(),
      ),

      atom.commands.add(editorElement, "bracket-matcher-plus:select-inside-brackets", () =>
        this.selectInsideBrackets(),
      ),

      atom.commands.add(editorElement, "bracket-matcher-plus:close-tag", () => this.closeTag()),

      atom.commands.add(editorElement, "bracket-matcher-plus:remove-matching-brackets", () =>
        this.removeMatchingBrackets(),
      ),

      atom.commands.add(editorElement, "bracket-matcher-plus:select-matching-brackets", () =>
  ...
  findPrecedingStartBracketWithRegexSearch(cursorPosition) {
    ...
    const endBracket = escapeRegExp(Object.keys(this.matchManager.pairedCharactersInverse).join(""));
  ...
  createMarker(bufferRange) {
    ...
    this.editor.decorateMarker(marker, {
      type: "highlight",
      class: "bracket-matcher bracket-matcher-plus",
      deprecatedRegionClass: "bracket-matcher bracket-matcher-plus",
    });
    return marker;
  }
